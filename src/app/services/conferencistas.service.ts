...
export class ConferencistasService {
  ...
  getConferencistas(pull: boolean = false) {
    ...
    return this.http.get<RespuestaProducto>(`${URL}/conferencistas/list/?pagina=${this.paginaSales}`, { headers });
  ...
  createConferencista(data: any, photo: File): any {
    ...
    return new Promise(resolve => {
      ...
      this.http.post(`${URL}/conferencistas`, fd, { headers })
        .subscribe(resp => {
  ...
  updateConf(data: any, photo: File): Observable<any> {
    ...
    return this.http.put(`${URL}/conferencistas/updated/${data._id}`, fd, { headers });
  }
  ...
  getSaleAdm(id: string): Observable<any> {
    ...
    return this.http.get(`${URL}/conferencistas/adm/` + id, { headers });
  ...
  getMyCommerce(): Observable<any> {
    ...
    return this.http.get(`${URL}/expositores/commerce`, { headers });
  ...
  getCommerceUserMsj(id: string): Observable<any> {
    ...
    return this.http.get(`${URL}/expositores/commerceum/` + id, { headers });
  ...
  getDeliverys(pull: boolean = false) {
    ...
    return this.http.get<RespuestaDeliverys>(`${URL}/expositores/comidas/?pagina=${this.paginaSales}`);
  ...
  getComAdmTotalNP() {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmontotalnp`, { headers });
  ...
  getComAdmTotalB() {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmontotalb`, { headers });
  ...
  getComAdmTotalP() {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmontotalp`, { headers });
  ...
  getComAdmTotalU() {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmontotalu`, { headers });

  }

  // Eliminar Expositor
  eliminarData(id: string): Observable<Commerce> {

    const headers = new HttpHeaders({
      'x-token': this.usuarioService.token
    });

    return this.http.get(`${URL}/conferencistas/delete/` + id, { headers });
  ...
  updateOfferNoPhoto(offer: any): Observable<Offer> {
    ...
    return this.http.put(`${URL}/expositores/updated/${offer._id}`, params, { headers });
  ...
  updateOffer(offer: any, photo: File): Observable<Offer> {
    ...
    return this.http.put(`${URL}/expositores/updateimg/${offer._id}`, fd, { headers });
  ...
  getComAdmTotalHoy() {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmontotalt`, { headers });
  ...
  getComAdmTotalH() {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmontotalh`, { headers });
  ...
  getComAdmSoloU(page) {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmon/?pagina=${page}`, { headers });
  ...
  getComAdmSoloUs(pull: boolean = false) {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmon/?pagina=${this.paginaSales}`, { headers });
  ...
  getComAdmSoloUsEmails() {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmonemail`, { headers });
  ...
  getComAdmSoloOff(pull: boolean = false) {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmoff/?pagina=${this.paginaSales}`, { headers });
  ...
  getComAdmSoloHome(pull: boolean = false) {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/comadmhome/?pagina=${this.paginaSales}`, { headers });
  ...
  getComAdm(page) {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadm/?pagina=${page}`, { headers });
  ...
  getComAdmWhats(pull: boolean = false) {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmwhats/?pagina=${this.paginaSales}`, { headers });
  ...
  getComAdmViews(pull: boolean = false) {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmviews/?pagina=${this.paginaSales}`, { headers });
  ...
  getComAdmTel(pull: boolean = false) {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmtel/?pagina=${this.paginaSales}`, { headers });
  ...
  getComAdmCell(pull: boolean = false) {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmcell/?pagina=${this.paginaSales}`, { headers });
  ...
  getComAdmWhatSoloU(pull: boolean = false) {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmwhatssu/?pagina=${this.paginaSales}`, { headers });
  ...
  getComAdmViewsSoloU(pull: boolean = false) {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmviewssu/?pagina=${this.paginaSales}`, { headers });
  ...
  getComAdmTelSoloU(pull: boolean = false) {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmtelsu/?pagina=${this.paginaSales}`, { headers });
  ...
  getComAdmCellSoloU(pull: boolean = false) {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmcellsu/?pagina=${this.paginaSales}`, { headers });
  ...
  getComAdmPage(pull: boolean = false) {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadm/?pagina=${this.paginaSales}`, { headers });
  ...
  getComAdmPageBorrados(pull: boolean = false) {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadborrados/?pagina=${this.paginaSales}`, { headers });
  ...
  getHomeAdm(page) {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmhome/?pagina=${page}`, { headers });
  ...
  getHomeAdmPage(pull: boolean = false) {
    ...
    return this.http.get<RespuestaCommerce>(`${URL}/expositores/cadmhome/?pagina=${this.paginaSales}`, { headers });
  ...
  getmySales() {
    ...
    return this.http.get<any>(`${URL}/expositores/expositores/?pagina=${this.paginaSales}`, { headers });
  ...
  getMyStats(id: string) {
    ...
    return this.http.get<any>(`${URL}/expositores/mis_visitas/` + id, { headers });
  ...
  getMyStatsF(id: string) {
    ...
    return this.http.get<any>(`${URL}/expositores/mis_llamadasf/` + id, { headers });
  ...
  getMyStatsC(id: string) {
    ...
    return this.http.get<any>(`${URL}/expositores/mis_llamadasc/` + id, { headers });
  ...
  getMyStatsW(id: string) {
    ...
    return this.http.get<any>(`${URL}/expositores/mis_whatsapp/` + id, { headers });
  ...
  getMyStatsS(id: string) {
    ...
    return this.http.get<any>(`${URL}/expositores/mis_compartir/` + id, { headers });
  ...
  updateCom(commer: any, photo: File): Observable<Commerce> {
    ...
    return this.http.put(`${URL}/expositores/update/${commer._id}`, fd, { headers });
  ...
  updateCom2(commer: any, photo: File): Observable<Commerce> {
    ...
    return this.http.put(`${URL}/expositores/update2/${commer._id}`, fd, { headers });
  }
  ...
  updateCom3(commer: any, photo: File): Observable<Commerce> {
    ...
    return this.http.put(`${URL}/expositores/update3/${commer._id}`, fd, { headers });
  ...
  updateCom4(commer: any, photo: File): Observable<Commerce> {
    ...
    return this.http.put(`${URL}/expositores/update4/${commer._id}`, fd, { headers });
  ...
  updateCom5(commer: any, photo: File): Observable<Commerce> {
    ...
    return this.http.put(`${URL}/expositores/update5/${commer._id}`, fd, { headers });
  ...
  updateSale(sale): Observable<Commerce> {
    ...
    return this.http.put(`${URL}/expositores/updated/${sale._id}`, params, { headers });
  ...
  updateSaleAdm(sale): Observable<Commerce> {
    ...
    return this.http.put(`${URL}/expositores/updatedadm/${sale._id}`, params, { headers });
  ...
  updateCompartir(sale): Observable<Commerce> {
    ...
    return this.http.put(`${URL}/expositores/updatedcomp/${sale._id}`, params, { headers });
  ...
  updateComB(sale): Observable<Commerce> {
    ...
    return this.http.put(`${URL}/expositores/updbo/${sale._id}`, params, { headers });
  ...
  updateSalefinal(sale): Observable<Commerce> {
    ...
    return this.http.put(`${URL}/expositores/update`, params, { headers });
  ...
  eliminarImg2(id): Observable<Commerce> {
    ...
    return this.http.put(`${URL}/expositores/deleteimg2/${id._id}`, params, { headers });
  }
  ...
  eliminarImg3(id): Observable<Commerce> {
    ...
    return this.http.put(`${URL}/expositores/deleteimg3/${id._id}`, params, { headers });
  ...
  eliminarImg4(id): Observable<Commerce> {
    ...
    return this.http.put(`${URL}/expositores/deleteimg4/${id._id}`, params, { headers });
  }
  ...
  eliminarImg5(id): Observable<Commerce> {
    ...
    return this.http.put(`${URL}/expositores/deleteimg5/${id._id}`, params, { headers });
