...
@Component({
  selector: 'app-conferencistas-add',
  templateUrl: './conferencistas-add.page.html',
  styleUrls: ['./conferencistas-add.page.scss'],
})
export class ConferencistasAddPage {
  ...
  // ! CREATE
  async createData() {
    this.presentLoading('Creando Conferencista...');

    await this.confService
      .createConferencista(this.dataForm.value, this.file)
      .then(
        async res => {
          // console.log(res)
          if (res.data) {
