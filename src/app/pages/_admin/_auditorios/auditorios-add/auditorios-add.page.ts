...
// import { ExpositoresService } from '../../../services/offers.service';
...
@Component({
  selector: 'app-auditorios-add',
  templateUrl: './auditorios-add.page.html',
  styleUrls: ['./auditorios-add.page.scss'],
})
export class AuditoriosAddPage implements OnInit {
